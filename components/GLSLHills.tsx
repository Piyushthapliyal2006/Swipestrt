...
const GLSLHills = ({ width = '100vw', height = '100vh', cameraZ = 125, planeSize = 256, speed = 0.5 }) => {
        ...
        return new THREE.Mesh(
          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                float opacity = (256.0 - length(vPosition)) / 256.0 * 0.9;
                opacity = max(0.0, opacity);
                // Vibrant blue/purple color matching SwipeStart theme
  ...
  return (
    <div ref={containerRef} style={{ position: 'fixed', top: 0, left: 0, width, height, zIndex: 0, pointerEvents: 'none' }}> 
      <canvas
        ref={canvasRef}
        style={{
          position: 'absolute',
